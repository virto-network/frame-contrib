    ...
    mod membership {
        ...
        fn passing_poll_executes() {
            new_test_ext().execute_with(|| {
                ...
                System::assert_has_event(
                    pallet_referenda::Event::<Test>::ConfirmStarted { index: 0 }.into(),
                );
        ...
        fn tie_breaking_works() {
            fn run_referenda() -> sp_io::TestExternalities {
                ...
                ext.execute_with(|| {
                    ...
                    // After voting, the poll starts confirmation
                    System::assert_has_event(
                        pallet_referenda::Event::<Test>::ConfirmStarted { index: 2 }.into(),
                    );
                });
    ...
    mod asset_balance {
        ...
        fn passes_with_approval_and_support() {
            new_test_ext().execute_with(|| {
                ...
                System::assert_has_event(
                    pallet_referenda::Event::<Test>::ConfirmStarted { index: 1 }.into(),
                );
    ...
    mod rank {
        ...
        fn it_works() {
            new_test_ext().execute_with(|| {
                ...
                System::assert_has_event(
                    pallet_referenda::Event::<Test>::ConfirmStarted { index: 3 }.into(),
                );
            });
        }
...
mod remove_vote {
    ...
    fn it_works() {
        new_test_ext().execute_with(|| {
            ...
            assert_eq!(
                Referenda::as_ongoing(0)
                    .expect("we already created poll 0; qed")
                    .0,
                Tally::default()
            );
        });
        ...
        new_test_ext().execute_with(|| {
            ...
            assert_eq!(
                Referenda::as_ongoing(2)
                    .expect("we already created poll 2; qed")
                    .0,
                Tally::default()
            );
